      ...
      <div className="relative p-8 bg-black bg-opacity-90 min-h-screen">
        <div className="flex flex-col md:flex-row items-center md:items-start justify-between space-y-8 md:space-y-0 md:space-x-8">
          ...
          <div className="w-full md:w-2/3 space-y-4 text-white">
            ...
            <Link to={Successful}><button type="button" class="focus:outline-none text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800">Book Tickets</button></Link>
